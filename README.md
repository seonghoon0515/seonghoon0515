<h1>:star: Hi there! I'm SeongHoon :star:</h1>
...
**<h4>:peach:현재 스파르타 코딩클럽 국비지원 앱/웹 과정수료를 정상적으로 수료 및 파이썬 및 Sql 관련해서 추가적으로 공부를 진행중에 있습니다.</h4>**

:balloon: **최종적인 목표인 백엔드 개발자가 되기 위해 사고력을 키우기 위해 알고리즘 공부를 진행중에 있습니다.** 
